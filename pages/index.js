...
const DUMMY_EVENTS2 = [
  {
    ...
    location: 'Somestreet 25, 12345 San Somewhereo',
    date: '2021-05-12',
    image: 'http://farm66.staticflickr.com/65535/51266869933_12eb3c418e.jpg',
    isFeatured: false,
  },
  {
    id: 'e2',
...
export default function HomePage(props){
  const [state, setState] = useState(props.meetup)
  useEffect(() => {

    setTimeout(()=>{
      setState(DUMMY_EVENTS2);
    },5000)
	...
	return <MeetupList meetups={state} />
}
